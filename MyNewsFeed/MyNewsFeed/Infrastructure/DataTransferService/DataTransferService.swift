...
public final class DataTransferServiceImp {
	...
	public init(with networkService: NetworkService,
				errorResolver: DataTransferErrorResolver = DataTransferErrorResolverImp(),
				errorLogger: DataTransferErrorLogger = DataTransferErrorLoggerImp()) {
...
extension DataTransferServiceImp: DataTransferService {
